/* =============================================================
   ...
   (function () {
    ...
    const AUDIO = {
      ...
      n3FinalNivel: 'src/sonidos/nivel3/final_nivel3.mp3' /* <-- Agregado */
    };
    ...
    function cargarActividadN3(indice) {
      ...
      Nivel3.cargarGrupo(config, {
        onCorrecto: () => {
          ...
          if (esUltimo) {
            // Si es el último, reproduce el audio de cierre final del Nivel 3
            Sonido.reproducirNarracion(AUDIO.n3FinalNivel);
            lanzarConfeti();
            setTimeout(() => {
            ...
            // Si quedan grupos, reproduce el efecto de acierto normal
